...
export default function(context) {
    ...
    function showBundle() {
        ...
        $('#halo-bundle-products .bundle-product-right').append('<div class="halo-product-total"><div class="total-price"><span class="text">Total:</span><span class="price"></span></div><a class="button button--primary halo-product-total-button" id="halo-addAll" href="#">Add All To Cart</a></div>');
    ...
    function updateCartContent(modal, cartItemId, onComplete) {
        ...
        $('#cart-preview-dropdown').parent().addClass('is-open');
        $('#cart-preview-dropdown').addClass('f-open-dropdown').addClass('is-open');
    ...
    function getCartPage() {
       let productCount = parseInt(document.querySelectorAll(".halo-product-item.isChecked").length);
        let oldQuantity = document.querySelector(".cart-quantity");

        let newquantity = parseInt(oldQuantity.innerHTML) + productCount;
